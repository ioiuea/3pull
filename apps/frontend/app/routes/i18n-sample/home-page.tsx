    ...
    <main className="container mx-auto max-w-2xl py-12 px-4 h-screen">
      <Card>
        ...
        <CardContent className="flex gap-3">
          <Button asChild>
            <Link to={`/${currentLanguage}/about`}>{t("home.aboutLink")}</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link to={`/${nextLanguage}`}>{t("home.switchLanguage")}</Link>
          </Button>
        </CardContent>
      </Card>
    </main>
...
export default I18nSampleHomePage;
