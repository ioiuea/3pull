              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormMessage>
                      {toErrorText(form.formState.errors.fullName?.message)}
                    </FormMessage>
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormMessage>
                      {toErrorText(form.formState.errors.profile?.department?.message)}
                    </FormMessage>
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex items-center justify-between rounded-lg border p-3">
                    ...
                    <FormMessage>
                      {toErrorText(form.formState.errors.agreeToTerms?.message)}
                    </FormMessage>
                  </FormItem>
                )}
              />
      ...
      <Card className="mt-4">
        ...
        <CardContent>
          <pre className="overflow-x-auto rounded-md border bg-muted/30 p-3 text-xs leading-relaxed">
            <code>
              {submittedValues ? JSON.stringify(submittedValues, null, 2) : t('result.empty')}
            </code>
          </pre>
        </CardContent>
      </Card>
