...
const ZustandSamplePage = () => {
  ...
  const { count, increment, decrement, setCount, reset: resetNumberState } = useNumberSampleStore();
  const { isPublished, togglePublished, reset: resetBooleanState } = useBooleanSampleStore();
  const {
    profile,
    setProfileName,
    setProfileRole,
